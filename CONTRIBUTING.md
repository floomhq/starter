...
3. Make your change
4. Run `cd cli && npm install && npm test && npm pack` to verify CLI still works
...
- Match existing JavaScript, Markdown, and JSON style (no big rewrites in unrelated files)
