...
// Path to the bundled skills directory in the packs repo (sibling to starter-cli)
// When installed via npm, skills are not available — we embed them in bundled-skills.js instead.
// This path is used only when running from the source tree.
const BUNDLED_SKILLS_DIR = path.resolve(__dirname, "..", "..", "packs", "starter", "skills");
